...
<?php if (is_single()) { ?>
    <div class="next-prev">
        <?php if ($prev_post = get_previous_post()) : ?>
            <div class="prev-post">
                <strong class="next-prev-title"><?php echo esc_html__('Previous Post', 'maximus-movie-video'); ?></strong>

                <?php
                $prev_video_thumb = maximus_movie_video_get_embed_thumbnail($prev_post->ID);
                if ($prev_video_thumb) {
        ...
        <?php if ($next_post = get_next_post()) : ?>
            <div class="next-post">
                <strong class="next-prev-title"><?php echo esc_html__('Next Post', 'maximus-movie-video'); ?></strong>

                <?php
                $next_video_thumb = maximus_movie_video_get_embed_thumbnail($next_post->ID);
                if ($next_video_thumb) {
