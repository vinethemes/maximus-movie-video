...
<?php
    $video_embed = maximus_movie_video_get_first_video_embed();
$thumbnail_url = maximus_movie_video_get_embed_thumbnail(get_the_ID());
...
<div id="content-wrap" class="clearfix">
    ...
    <div id="content" tabindex="-1" class="<?php echo (get_theme_mod('maximus_movie_video_general_sidebar_post') == true) ? 'fullwidth' : ''; ?>">
                    ...
                    <div class="box">
                        <div class="frame">
                            <div class="top-part-wrap">
                                ...
                                <?php if (!$video_embed && has_post_thumbnail()) : ?>
                                    <a class="featured-image" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                                        <?php the_post_thumbnail('maximus-movie-video-large-image'); ?>
                                    </a>
                                <?php endif; ?>
                            ...
                            <div class="post-content">
                                <?php echo wp_kses_post(maximus_movie_video_remove_first_video_block(get_the_content())); ?>
        ...
        <?php if (get_theme_mod('maximus_movie_video_general_author_post') != true) {
            do_action('maximus_movie_video_authorbox');
        } ?>
...
<?php if (!get_theme_mod('maximus_movie_video_general_sidebar_post')) {
    get_sidebar();
} ?>
<?php get_footer(); ?>
