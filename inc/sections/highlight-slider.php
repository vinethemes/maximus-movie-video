<?php
/**
 * Template for the Highlight Slider Section on the homepage.
 *
...
<?php if ( get_theme_mod('maximus_movie_video_highlight_slider_enable', 'enable') !== 'disable' ) : ?>

    <div class="slider-wrapper23 highlight-slider-section container">
        
        <div class="section-title">
            <?php echo esc_html(get_theme_mod('maximus_movie_video_highlight_slider_title', esc_html__('Highlights', 'maximus-movie-video'))); ?>
        </div>

        <div class="maximus_movie_video_slides highlight-slider-grid">
            <?php
            $maximus_movie_video_image_size = "maximus-movie-video-slider-image";
            $maximus_movie_video_number     = get_theme_mod('maximus_movie_video_highlight_slider_posts', 10);
            $maximus_movie_video_category   = get_theme_mod('maximus_movie_video_highlight_slider_category');
