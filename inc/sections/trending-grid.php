...
<?php if ( get_theme_mod('maximus_movie_video_trending_grid_enable', 'enable') !== 'disable' ) : ?>

    <div class="slider-wrapper23 two-row-grid-section trending-grid container">
        <div class="section-title"><?php echo esc_html(get_theme_mod('maximus_movie_video_trending_grid_title', esc_html__('Trending Movies', 'maximus-movie-video'))); ?></div>
        <div class="maximus_movie_video_slides ">
            <?php
            $maximus_movie_video_image_size = "maximus-movie-video-twogrid-image";
            $maximus_movie_video_number = get_theme_mod('maximus_movie_video_trending_grid_posts', 18); // default to 16 posts
            $maximus_movie_video_category = get_theme_mod('maximus_movie_video_trending_grid_category');
