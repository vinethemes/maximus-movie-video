<?php
/**
 * Template for the Two Row Grid Posts Section on the homepage.
 *
...
<?php if ( get_theme_mod('maximus_movie_video_below_slider_enable', 'enable') !== 'disable' ) : ?>

    <div class="slider-wrapper23 two-row-grid-section container">
        <div class="section-title"><?php echo esc_html(get_theme_mod('maximus_movie_video_below_slider_title', esc_html__('New Releases', 'maximus-movie-video'))); ?></div>
        <div class="maximus_movie_video_slides ">
            <?php
            $maximus_movie_video_image_size = "maximus-movie-video-twogrid-image";
            $maximus_movie_video_number = get_theme_mod('maximus_movie_video_below_slider_posts', 16); // default to 16 posts
            $maximus_movie_video_category = get_theme_mod('maximus_movie_video_below_slider_category');
