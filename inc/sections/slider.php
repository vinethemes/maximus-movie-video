...
?>
    ...
    <!--  scroller -->
<?php if ( get_theme_mod('maximus_movie_video_customizer_mainslider_disable') != 'disable') { ?>
        ...
        <div class="slider-wrapper23 main slider">
            ...
            <div class="maximus_movie_video_slides">
                ...
                $maximus_movie_video_number23 = get_theme_mod('maximus_movie_video_mainslider_slides');
                $maximus_movie_video_category2 = get_theme_mod('maximus_movie_video_mainslider_category');

                $maximus_movie_video_featured_list_args2  = array(
                    'posts_per_page' => $maximus_movie_video_number23,
                    'cat' => $maximus_movie_video_category2
                );
                $maximus_movie_video_featured_list_posts = new WP_Query($maximus_movie_video_featured_list_args2);
                ?>
...
while ($maximus_movie_video_featured_list_posts->have_posts()) : $maximus_movie_video_featured_list_posts->the_post();
...
<?php
    ...
    $maximus_movie_video_image = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), $maximus_movie_video_image_size); ?>
    <div class="image-slide">
        <a href="<?php echo esc_url(get_permalink()); ?>">
            <img src="<?php echo esc_url($maximus_movie_video_image[0]); ?>" alt="<?php echo esc_attr($image_alt); ?>" width="<?php echo $maximus_movie_video_image[1]; ?>" height="<?php echo $maximus_movie_video_image[2]; ?>" />
        </a>
    </div>
<?php
} else {
                ...
                <div class="feat-overlay">
                    <div class="feat-inner">
                        ...
                        <div class="slider-meta">
                            <div class="scroll-post"><?php echo maximus_movie_video_getCategory(); ?></div>
                            <div class="post-date"><a href="<?php the_permalink(); ?>"><?php echo maximus_movie_video_time_ago_custom(get_the_date('c')); ?></a></div>
