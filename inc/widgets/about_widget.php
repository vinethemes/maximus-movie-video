...
add_action( 'widgets_init', 'maximus_movie_video_about_load_widget' );

function maximus_movie_video_about_load_widget() {
	register_widget( 'maximus_movie_video_about_widget' );
}

class maximus_movie_video_about_widget extends WP_Widget {
    ...
    {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'maximus_movie_video_about_widget', 'description' => __('An About Me Widget', 'maximus-movie-video') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'maximus_movie_video_about_widget' );

		/* Create the widget. */
        parent::__construct(  'maximus_movie_video_about_widget', __('Maximus Movie Video: About Me', 'maximus-movie-video'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- image url -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'image' )); ?>"><?php esc_html_e( 'Image URL','maximus-movie-video' ); ?></label>
		...
		<!-- subtitle -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'subtitle' )); ?>"><?php esc_html_e( 'Sub title','maximus-movie-video' ); ?></label>
		...
		<!-- description -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e( 'About me text','maximus-movie-video' ); ?></label>
		...
		<!-- autograph url -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'signing' )); ?>"><?php esc_html_e( 'Autograph Image URL','maximus-movie-video' ); ?></label>
