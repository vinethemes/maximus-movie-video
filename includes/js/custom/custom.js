...
// Sub Menu
    ...
    $(".maximus-movie-video-toggle").click(function() {
        var index = $(this).data("index");
        $(".maximus_movie_video_slides").removeClass("active");
        $(".maximus_movie_video_slides").eq(index).addClass("active");
    });

    $(".maximus-movie-video-toggle").click(function() {
        if (!$(this).hasClass("active")) {
            $(".maximus-movie-video-toggle").removeClass("active").addClass("notactive");
