...
<div class="footer-copy clearfix">
    <p class="copyright">
        <?php echo wp_kses_post( get_theme_mod('footer_copyright', __('Copyright © 2025. All Rights Reserved.', 'maximus-movie-video')) ); ?>
    </p>
    ...
    <div class="theme-author">
        ...
        <?php else: ?>
            Designed by <a href="<?php echo esc_url('https://www.vinethemes.com/'); ?>">
                <?php esc_html_e('VineThemes', 'maximus-movie-video'); ?>
            </a>
        <?php endif; ?>
    </div>
</div>
